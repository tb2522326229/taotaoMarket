...
function clothingAbTest() {
	if ("home" == pageConfig.navId) {
		...
		if (a) {
			var b = getHashProbability(a, 1e4),
				c = $("#_JD_ALLSORT div.fore6"),
				d = c.find(".subitem .fore1 dt a"),
	...
	"function" != typeof JSON.stringify && (JSON.stringify = function(a, b, c) {
		...
		function walk(a, b) {
			...
			if (e && "object" == typeof e)
				for (c in e)
					Object.prototype.hasOwnProperty.call(e, c) && (d = walk(e, c), void 0 !== d ? e[c] = d :
						delete e[c]
					);
		...
		return {
			...
			parse : function(text, reviver) {
				function walk(a, b) {
					...
					if (e && "object" == typeof e)
						for (c in e)
							Object.hasOwnProperty.call(e, c) && (d = walk(e, c), void 0 !== d ? e[c] = d :
								delete e[c]
							);
					return reviver.call(a, b, e)
				}
...
!function() {
		...
		_jsonp : {
			...
			name : function(callback) {
				...
				var cb = function(json) {
					eval("delete " + name), callback(json), $._jsonp.head.removeChild($._jsonp.scripts[name]),
			...
			var d,
				...
				j = function(a, b) {
					var c,
						...
						h,
						i,
						j = f.threshold ? parseInt(f.threshold) : 0;
	...
	a.jdCalcul = function(b) {
		var c = null,
			b = b.join(","),
			d = "http://qiang.jd.com/HomePageNewLimitBuy.ashx?callback=?&ids=" + b,
			e = "http://item.jd.com/",
			f = function(b) {
				var c = a.extend({
					contentid : "#limit",
...
var jdRecent = {
	...
	init : function() {
		...
		if (this.list && null != this.list && "" != this.list)
			"" == b || -1 != this.list.indexOf(b) ? this.list = this.list : (this.list.split(".").length >= 10 && (this.list = this.list.replace(/.\d+$/, "")), this.list = b + "." + this.list);else {
			if ("" == b)
...
var category = {
		...
		URL_Serv: "http://localhost:8091/rest/item/cat/list?callback=category.getDataService",
